...
// -----------------------------------------------------------------------
// Example parameter file: Daily schedule (runs every N days at startTime)
// -----------------------------------------------------------------------
...
// Schedule: Daily - runs every `scheduleInterval` days starting at scheduleStartTime
param scheduleName = 'sch-sql-scheduler-daily'
param scheduleDescription = 'Runs the SQL scheduler runbook every day at 02:00 Europe/Rome.'
param scheduleFrequency = 'Day'
param scheduleInterval = 1 // every 1 day
...
param scheduleWeekDays = [] // ignored for Day frequency
